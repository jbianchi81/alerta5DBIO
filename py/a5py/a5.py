...
def readEstaciones(estacion_id=None,id_externo=None,tabla=None,use_proxy=False):
    response = requests.get("%s/obs/puntual/estaciones" % config["api"]["url"],
        params = {
