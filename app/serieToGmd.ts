...
function serieToGmd(serie : Serie) : string {    
    ...
    const timeend = (serie.date_range.timeend) ? (serie.var.timeSupport) ? advanceTimeStep(serie.date_range.timeend, serie.var.timeSupport) : serie.date_range.timeend : undefined
