...
const internal = {
     ...
     */
    importRaster: (filename_1, timestart_1, ...args_1) => __awaiter(void 0, [filename_1, timestart_1, ...args_1], void 0, function* (filename, timestart, dt = new timeSteps_1.Interval({ days: 1 }), time_support = new timeSteps_1.Interval({}), series_id
