...
FROM pg_catalog.pg_constraint con
    ...
    INNER JOIN fuentes ON rel.relname = fuentes.data_table
WHERE nsp.nspname = 'public' group by rel.relname, con.conname, con.contype;

GRANT SELECT ON table_constraints TO actualiza;

DROP MATERIALIZED VIEW IF EXISTS series_areal_json;
...
GRANT SELECT ON series_areal_json TO actualiza;
ALTER TABLE series_areal_json OWNER TO actualiza;
