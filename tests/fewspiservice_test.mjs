...
test('accessor timeseries areales', async() => {
    ...
    for(const s of series) {
        ...
        assert("observaciones" in s)
        assert(Array.isArray(s.observaciones))
        assert(s.observaciones.length >= 8)
